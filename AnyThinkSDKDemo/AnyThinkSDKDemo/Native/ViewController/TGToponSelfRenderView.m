...
//#import <TGCommonBaseModule/TGCustomLayoutButton.h>
//#import <TGCommonBaseModule/UIImage+TGCustomImage.h>
//#import <TGCommonBaseModule/UIColor+TGCustomColor.h>
...
- (void)createUI {
    ...
    CGSize dislikeImgSize = CGSizeMake(10, 10);
    UIColor *dislikeColor = [UIColor tg_colorWithHexString:@"#8B9FBC"];
    UIImage *dislikeImage = [UIImage tg_svgImageNamed:@"common_adClose" size:dislikeImgSize color:dislikeColor];
...
- (void)layoutUI {
    ...
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (containsCta) {
            ...
            make.trailing.mas_equalTo(self.mas_leading).mas_offset(-10);
        }
    }];
